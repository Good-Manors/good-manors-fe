...
const bgImageArrayVert = [bathroom, catYard, dining, garden, kidRoom, kitchen, nook];
...
useEffect(() => {
  ...
  setTimeout(() => {
    ...
    bgRef.current.style.background = `url(${bgImageArrayVert[bgMap[bgCurrent]]}) no-repeat center center fixed`;
  ...
  bathroom, catYard, dining, garden, kidRoom, kitchen, nook
  return (
